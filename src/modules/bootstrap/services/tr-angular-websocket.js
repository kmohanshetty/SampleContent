...
// @TODO Refactor to a standalone repo to track updates to this file and allow for reuse throughout TR
// @TODO Restructure to match Angular coding standards (https://thehub.thomsonreuters.com/docs/DOC-1009708)
  ...
  function $WebSocketProvider($rootScope, $q, $timeout, $websocketBackend) {
    ...
    $WebSocket.prototype.close = function close(force) {
      if (force || !this.socket.bufferedAmount) {
        ...
        if (this.socket.readyState === this._readyStateConstants.OPEN) {
          this.socket.close();
        }
      }
      return this;
